...
export default function WorkspaceDetailsPage() {
  ...
  const handleEditWorkspace = () => {
    if (!canManage) return;
    router.push(`/dashboard/settings/workspace/${workspaceId}/edit`);
  };
                  ...
                  {canManage ? (
                    <div className="mt-2 flex items-center gap-2">
                      {hasPaidPlan ? (
                        ...
                        <Button onClick={() => router.push(`/dashboard/settings/workspace/${workspace.id}/billing`)} className="w-full">
                          Assinar plano
                        </Button>
                      )}
                    </div>
